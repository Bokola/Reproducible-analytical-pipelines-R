...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Housing Data For Luxembourg - A fusen inspired analysis as a package",
    Description = "This package contains functions to get, clean and analyse housing price data for Luxembourg.",
    `Authors@R` = c(
      person("Basil", "Okola", email = "okolabasilowiti@gmail.com", role = c("aut", "cre")
...
Not required as we are already using a repository
...
# Inflate get_data.Rmd

Start by inflating `dev/get_data.Rmd` to document data.

```{r dev-inflate, eval=FALSE}
# eval = FALSE avoids infinite loop
...
# eval = FALSE avoids infinite loop
# execute in the console directly
fusen::inflate(flat_file = "dev/analyze.Rmd",
               vignette_name = "analyze",
               overwrite = TRUE,
               document = TRUE,
               open_vignette = TRUE)
```
